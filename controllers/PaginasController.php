...
class PaginasController {
    ...
    public static function contacto( Router $router ) {
        ...
        if($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = '5745e70b651d73';
            $mail->Password = '956b73a01dd7f4';
            $mail->SMTPSecure = 'tls';
            $mail->Port = 2525;
        
            $mail->setFrom('admin@casabarata.com', $respuestas['nombre']);
            $mail->addAddress('admin@casabarata.com', 'CasaBarata.com');
